...
data_path = "D:/code/Datasets/Xiamen_data/origin/train.csv"
label_path = "D:/code/Datasets/Xiamen_data/origin/train_target.csv"
predict_data_path = "D:/code/Datasets/Xiamen_data/origin/test.csv"
...
for train_index, test_index in kf.split(X_train):
    ...
    if auc > max_auc:
        ...
        print(">>>>", res)
        csv_file = 'D:/code/Datasets/Xiamen_data/result/' + str(n_splits) + '_' + str(auc) + '.csv'
        res.to_csv(csv_file)
